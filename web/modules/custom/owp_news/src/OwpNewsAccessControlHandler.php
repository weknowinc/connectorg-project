 ...
 *
 * @see \Drupal\owp_news\Entity\OwpNews.
 */
class OwpNewsAccessControlHandler extends EntityAccessControlHandler {

  /**
   * {@inheritdoc}
   */
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    /** @var \Drupal\owp_news\Entity\OwpNewsInterface $entity */
