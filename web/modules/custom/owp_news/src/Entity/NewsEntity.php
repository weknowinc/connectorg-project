 ...
 *     "list_builder" = "Drupal\owp_news\NewsEntityListBuilder",
 *     "views_data" = "Drupal\owp_news\Entity\NewsEntityViewsData",
 *     "translation" = "Drupal\owp_news\NewsEntityTranslationHandler",
 *
 *     "form" = {
 *       "default" = "Drupal\owp_news\Form\NewsEntityForm",
 *       "add" = "Drupal\owp_news\Form\NewsEntityForm",
 *       "edit" = "Drupal\owp_news\Form\NewsEntityForm",
 *       "delete" = "Drupal\owp_news\Form\NewsEntityDeleteForm",
 *     },
 *     "route_provider" = {
 *       "html" = "Drupal\owp_news\NewsEntityHtmlRouteProvider",
 *     },
 *     "access" = "Drupal\owp_news\NewsEntityAccessControlHandler",
 *   },
 *   base_table = "news_entity",
 *   data_table = "news_entity_field_data",
 *   translatable = TRUE,
...
class NewsEntity extends ContentEntityBase implements NewsEntityInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['status']->setDescription(t('A flag to indicate whether this article is published.'))
      ->setDisplayOptions('form', [
