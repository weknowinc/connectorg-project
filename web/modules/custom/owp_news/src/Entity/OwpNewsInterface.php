 ...
 * @ingroup owp_news
 */
interface OwpNewsInterface extends ContentEntityInterface, EntityChangedInterface, EntityPublishedInterface, EntityOwnerInterface {
   ...
   *   The News name.
   *
   * @return \Drupal\owp_news\Entity\OwpNewsInterface
